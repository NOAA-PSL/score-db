...
def test_put_exp_array_metrics_request():
    request_dict = {
        ...
        'body': {
            ...
            'array_metrics': [
                ExptArrayMetricInputData('vertical_example_metric','global',[[1, 2, 3],[4, 5, 6],[7, 8, 9]], True, '2015-12-02 06:00:00', None, None),
                ExptArrayMetricInputData('vertical_example_metric2','global',[[111, 222, 333],[444, 555, 666],[777, 888, 999]], True, '2015-12-02 18:00:00', 24, 12)
            ],
...
def test_put_exp_array_metrics_request_with_sat():
    request_dict = {
        ...
        'body': {
            ...
            'expt_wallclock_start': '2021-07-22 09:22:05',
            'array_metrics': [
                ExptArrayMetricInputData('vertical_example_metric3','global',[[1, 2, 3],[4, 5, 6],[7, 8, 9]], True, '2015-12-02 06:00:00', None, None, 'example_sat_meta'),
                ExptArrayMetricInputData('vertical_example_metric4','global',[[111, 222, 333],[444, 555, 666],[777, 888, 999]], True, '2015-12-02 18:00:00', 24, 12, 'example_sat_meta', 123456789, 'Example Sat Name', 'esm__1')
            ],
            'datestr_format': '%Y-%m-%d %H:%M:%S'
        }
    }
    ...
    request_dict = {
        ...
        'params': {
            ...
            'filters': {
                ...
                'metric_types': {
                    'name': {
                        'exact': ['vertical_example_metric4']
                    },
                },
                'regions': {
                    'name': {
