...
def test_expt_file_counts_commit():
    put_request_dict = {
        'db_request_name': 'expt_file_counts',
        'method': 'PUT',
        'body': {
    ...
    efcr_put = ExptFileCountRequest(put_request_dict)
    result_put = efcr_put.submit()
    print(f'Expt File Counts PUT results: {result_put}')
    ...
    efcr_get = ExptFileCountRequest(get_request_dict)
    result_get = efcr_get.submit()
    print(f'Expt File Counts GET results: {result_get}')
